...
// ─────────────────────────────────────────────────────────────────────────────
// LIVE CURVE STATE READS
// ─────────────────────────────────────────────────────────────────────────────
// Token discovery and trade history are now served by the backend indexer
// (the single shared read layer — see backend/src/indexer.ts). Clients no longer
// scan chain logs per-browser; they fetch the canonical list from the backend and
// use the write helpers below for on-chain buy/sell/launch. getOnChainReserves and
// refreshTokenReserves remain for optimistic post-trade reconciliation of a single
// curve's live reserve state.
